 ...
 * @author admin
 */
@WebServlet(name="RegistrationApi", urlPatterns={"/registration-api"})
public class RegistrationApi extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        super.init(config);
        config.getServletContext().setAttribute("/registration-api", this);
    }
    ...
    throws ServletException, IOException {
        try {
            ...
            if (pathInfo == null || pathInfo.equals("/")) {
                ...
                List<Registration> registrations = registrationDAO.findByUserId(userAuth.getId());
                for (Registration registration : registrations) {
                    registration.setSubjectPackageFunc();
                }
                JsonObject responseObj = new JsonObject();
                responseObj.addProperty("success", true);
                responseObj.addProperty("message", "Registrations retrieved successfully");
                responseObj.add("data", gson.toJsonTree(registrations));
